...
(async () => {
  ...
  expect(/themeshvault-shell-v40/.test(worker) && /rendezvousConfig\.js/.test(worker) && /distributed-rendezvous-provider\.js/.test(worker) && /patient-zero-operator\.js/.test(worker), "The installable app shell must cache the distributed rendezvous runtime and local operator gate.");
