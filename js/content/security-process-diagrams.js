...
export const coldStartProcessDiagram = `<figure class="architecture-process architecture-process--cold-start" aria-labelledby="cold-start-title">
  ...
  <div class="process-step-grid process-step-grid--recovery">
    ...
    <article class="process-step process-step--network"><b>06</b><span>Close forever</span><strong>Mesh-only operation</strong><p>The temporary row is deleted best-effort, the local anonymous session is cleared and this profile permanently stops using Supabase.</p></article>
  </div>
