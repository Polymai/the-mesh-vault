...
async function main() {
  ...
  try {
    ...
    await owner.page.evaluate(async () => {
      ...
      upsertPeer({ peerId: "live-mesh-refresh-contract", nodeName: "Newly discovered node", devicePublicKey: "live-mesh-refresh-key", protocolVersion: 1, capacityBytes: 4096 });
    });
