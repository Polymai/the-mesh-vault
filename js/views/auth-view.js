export function renderLanding() {
  ...
  <section id="mesh-in-one-look" class="mesh-story" aria-labelledby="mesh-story-title">
    ...
    <footer><strong>Your Mesh Key puts the file back together.</strong><a href="#/security">Security & Architecture <span aria-hidden="true">→</span></a></footer>
  </section>
