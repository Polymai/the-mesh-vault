...
import { anchorStatus, publishControlObject, queryAnchors } from "./network/anchor-service.js";
...
export function destroyApp() { clearControlRepository(); stopRecoveryCoordinator(); stopSurvivalService().catch(() => {}); pauseNode().catch(() => {}); }
