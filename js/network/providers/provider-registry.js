...
export async function discoverPeers(...args) { return fanOut(PROVIDER_KINDS.PEER_DISCOVERY, "discoverPeers", args); }
export async function sendSignal(...args) { return fanOut(PROVIDER_KINDS.SIGNALING, "sendSignal", args); }
export async function publishPresence(...args) { return fanOut(PROVIDER_KINDS.PRESENCE, "publishPresence", args); }
