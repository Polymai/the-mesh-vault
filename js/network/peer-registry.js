...
export function upsertPeer({ peerId, nodeName = null, devicePublicKey, protocolVersion, capacityBytes = 0, usedBytes = 0, availableStorageBytes, countryCode = null, regionCode = null, networkDomainHash = null, capabilities = [], reliabilityScore = null, survivalMode = false, leaseExpiresAt = null, uptimeSeconds = null, buddyNodeIds = [], trustStatus = "unverified" }) {
