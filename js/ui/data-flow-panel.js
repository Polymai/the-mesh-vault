...
const ROUTE_LABELS = Object.freeze({ direct: "Peer", anchor: "Backbone", rendezvous: "Rendezvous", supabase: "Supabase" });
...
export function renderDataFlowPanel() {
  return `<section class="panel data-flow-panel" data-data-flow-panel>
    ...
    <p>Web session only. WebRTC carries files; rendezvous relays and Supabase carry coordination only.</p>
  </section>`;
}
