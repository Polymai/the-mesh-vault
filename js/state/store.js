const initialState = Object.freeze({
  ...
  vaultProfile: { name: "", synced: false, syncStatus: "not-set" }, erasureClass: "auto",
  ...
  pwaInstall: { installed: false, available: false, prompting: false, platform: "other", browser: "other", os: "other", displayMode: "browser", lastOutcome: null },
  contributionLimitBytes: 1073741824,
  nativeNode: { supported: false, enabled: false, running: false, status: "Browser only", state: "unsupported", nodeId: null, vaultId: null, anchor: false, capacityBytes: 0, usedBytes: 0, shardCount: 0, controlCount: 0, controlBytes: 0, peerCount: 0, lastHeartbeatAt: 0, lastError: null, keysAccepted: false },
