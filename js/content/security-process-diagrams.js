  ...
  <div class="key-custody-map">
    ...
    <div class="process-output-stack">
      <article class="process-output process-output--control">
        <span>Mesh participants + Backbones + Supabase fallback</span><strong>Public and protected control data</strong>
...
export const coldStartProcessDiagram = `<figure class="architecture-process architecture-process--cold-start" aria-labelledby="cold-start-title">
  ...
  <div class="process-step-grid process-step-grid--recovery">
    ...
    <article class="process-step process-step--network"><b>06</b><span>Leave bootstrap</span><strong>Direct WebRTC + mesh gossip</strong><p>The peers establish normal mesh connections. Supabase is contacted only after the mesh-first attempt fails or a durable hosted transaction is required.</p></article>
  </div>
...
export const uploadProtectionProcessDiagram = `<figure class="architecture-process architecture-process--upload" aria-labelledby="upload-protection-title">
  ...
  <div class="process-destination-row">
    ...
    <span><b>Mesh control plane</b>Signed or encrypted metadata, hashes and placements; Supabase remains the durable fallback</span>
  </div>
