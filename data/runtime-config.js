(function () {
  ...
  window.__DATA__ = Object.freeze({
    ...
    release: Object.freeze({ version: "3.0", build: 49, label: "v3.0.49" }),
    ...
    coordination: Object.freeze({
      ...
      // One bounded cold-start window is allowed per browser/device profile.
      // It is permanently closed after the first verified mesh connection.
