...
const ROUTE_LABELS = Object.freeze({ direct: "Peer", anchor: "Backbone", supabase: "First contact" });
...
export function renderDataFlowPanel() {
  return `<section class="panel data-flow-panel" data-data-flow-panel>
    ...
    <p>Web session only. Supabase is available only until this profile verifies its first mesh peer. Patient Zero keeps the first-contact listener.</p>
  </section>`;
}
