...
export class SupabaseNodeRegistry {
  ...
  rows(status = "online") {
    ...
    return this.layout.instances.map((instance) => ({
      ...
      status,
      capacity_bytes: remotelyReachable ? instance.quotaBytes : 0,
      ...
      survival_mode: true,
      lifecycle_state: status === "online" ? "serving" : "stopped",
      lease_expires_at: iso(now + (status === "online" ? 15 * 60 * 1000 : 0)),
