...
const navItems = [
  ["dashboard", "Overview"], ["drive", "My Drive"], ["mesh", "Live Mesh"], ["anchor", "Backbone"], ["recovery", "Mesh Key"], ["settings", "Settings"],
];
...
function anchorRoleBadge(state, modifier = "") {
  return state.anchor?.enabled ? `<span class="anchor-role-badge${modifier ? ` anchor-role-badge--${modifier}` : ""}" title="This device is a stable Backbone participant"><i aria-hidden="true"></i>Backbone</span>` : "";
}
