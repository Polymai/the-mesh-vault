...
// A bounded recent-node sample supports semantic zoom without ever fetching
// the whole network. Network-wide totals still come from network_totals().
const MESH_VIEW_NODE_LIMIT = 240;
