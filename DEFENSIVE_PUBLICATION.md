...
- recovery of a 24 MiB file after the uploader disconnected, using established peers at 4/5 and 3/5, with correct rejection at 2/5;
...
- encrypted vault-index round-trip and tamper rejection;
- concurrent local operation sequencing and idempotent multi-device replay;
- signed repair-lease and distributed deletion-acknowledgement contracts;
