...
expect(/configureSupabaseBootstrapPolicy[\s\S]{0,500}bootstrapCompletedThisLifecycle = false/.test(policy), "A new app lifecycle must reset its bounded first-contact state.");
