...
const simpleArchitectureInfographic = `<figure class="architecture-simple" aria-labelledby="architecture-simple-title">
  ...
  <div class="architecture-simple__flow" aria-label="How a file moves through TheMeshVault">
    ...
    <article>
      ...
      <small>Your Mesh Key rebuilds the exact file.</small>
    </article>
  </div>
  <div class="architecture-simple__coordinator">
    <span aria-hidden="true">↔</span>
    <p><strong>Supabase helps devices find each other and remembers the map.</strong> The readable file is not stored in Supabase Storage.</p>
  </div>
  ...
  sections: [
    ...
    },
    {
      ...
      body: `<ol>
        ...
        <li><strong>Verified placement.</strong> Shards are transferred as 32 KiB WebRTC DataChannel packets, reassembled, hashed and acknowledged. Every shard group uses distinct browser/device failure domains. Across the whole file, placement first prefers devices that do not already hold one of its segments, then balances necessary reuse by capacity, reliability, network diversity and measured connection quality.</li>
    ...
    },
    {
      ...
      <div class="document-table-wrap"><table><thead><tr><th>Supabase capability</th><th>Why the current app uses it</th><th>Data involved</th></tr></thead><tbody>
        ...
        <tr><td>Database and Realtime</td><td>Coordinate vault registration, nodes, live presence, file/segment/shard records, placements, transfers, repair, rebalancing, deletion, sharing and network measurements.</td><td>Public keys, an owner-signed encrypted private vault profile, public node labels, encrypted metadata, sizes, hashes, status, coarse location and operational timestamps.</td></tr>
