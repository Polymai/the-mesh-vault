const initialState = Object.freeze({
  ...
  vaultProfile: { name: "" }, erasureClass: "standard",
  ...
  node: { id: null, status: "offline", capacityBytes: 0, usedBytes: 0, persistence: "unknown", countryCode: null, regionCode: null, locationSource: null, locationUpdatedAt: null },
  anchor: { enabled: false, status: "off", nodeName: "Browser node", cacheLimitBytes: 104857600, bytesUsed: 0, objectCount: 0, replicatedObjects: 0, connectedAnchors: 0, wakeLock: "released", warmIndependent: false },
  survival: { enabled: false, lifecycle: "stopped", leaseExpiresAt: null, leaseRemainingMs: 0, uptimeSeconds: 0, reliabilityScore: 0, reliabilityLabel: "unproven", buddyNodeIds: [], fullscreen: false, wakeAssistance: "unknown", serviceWorker: "unsupported", backgroundSync: "unsupported", lastHandoffAt: null },
